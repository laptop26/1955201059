...
<td class="center"><a href="hapuspustakawan.php?id=<?php echo $r['kodepustakawan']; ?>"><button> hapus</button></a></td>
...
<form method="post" action="inputpustakawan.php" >
<td><input type="submit" name="Tambah Pustakawan" value="Tambah Pustakawan"></td>
 </form>
