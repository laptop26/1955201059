...
?>
<div class="container">
  <h2>Daftar Siswa Melakukan Peminjaman Buku</h2>
  <p>Berikut ini:</p> 
  ...
  ?>
      <tr>
        ...
        <td><?php echo $r['kodepustakawankembali'];?></td>
        <td><?php echo $r['tanggalkembali'];?></td>
<td class="center"><a href="hapustransaksi.php?id=<?php echo $r['idtransaksi']; ?>"><button> hapus</button></a></td>
  </tr>
...
<td><input type="submit" name="Tambah Data Peminjaman Buku " value="Tambah Data Peminjaman Buku"></td>
 </form>
